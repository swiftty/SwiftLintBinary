...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SwiftLintBinary",
            url: "https://github.com/swiftty/SwiftLintBinary/releases/download/0.63.1/SwiftLintBinary.artifactbundle.zip",
            checksum: "9314e3761a26db2feefa9fd0b258370628f9319bab93305bfea8f96159b19a38"
        ),
        .plugin(
